...
public class PackValidator {
    ...
    public void validateOraxenItemPackData(ResourcePack resourcePack) {
        ...
        for (Map.Entry<String, PackData> oraxenItemMeta : oraxenItemMetas.entrySet()) {
            String itemId = oraxenItemMeta.getKey();
            PackData packData = oraxenItemMeta.getValue();

            if (resourcePack.model(packData.modelKey) == null) {
